...
// ✅ Passo 12 v2 — exibe servicosInclusos, sem cortesInclusos
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.75)', zIndex: 200, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
          <div style={{ background: dark ? '#1A0F0D' : '#fff', borderRadius: '24px 24px 0 0', padding: '28px 20px 40px', width: '100%', maxWidth: '430px' }}>
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              ...
              <div style={{ fontSize: '22px', fontWeight: '900', color: confirmando.cor || '#C9A84C', marginTop: '4px' }}>R$ {Number(confirmando.preco).toFixed(2)}<span style={{ fontSize: '13px', fontWeight: '400', color: textSub }}>/mês</span></div>
            </div>
